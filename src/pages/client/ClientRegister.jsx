...
export default function ClientRegister() {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    setError('')
    const res = clientAuth.register(form)
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-6"
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-gray-500 text-sm">Создайте аккаунт клиента</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          <label className="text-sm font-semibold text-gray-700 mb-1 block">Телефон (это ваш логин)</label>
      ...
      <p className="text-center text-sm text-gray-500 mt-6">
        Уже есть аккаунт?{' '}
        <Link to="/login" className="text-[#1a1a2e] font-semibold">Войти</Link>
      </p>
    </div>
  )
}
